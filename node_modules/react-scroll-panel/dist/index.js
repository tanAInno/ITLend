...
var Panel = function (_React$Component) {
  ...
  _createClass(Panel, [{
    key: "visible",
    value: function visible(node, panel) {
      var panelCoords = panel.getBoundingClientRect();
    ...
    key: "throttleScroll",
    value: function throttleScroll(evt) {
      var _this2 = this;

      clearTimeout(this.ticking);
      this.ticking = setTimeout(function () {
        _this2.handleScroll(evt);
      }, 66);
    }
  }, {
    key: "handleRef",
    value: function handleRef(evt) {
      this.panel = evt;
    ...
    value: function render() {
      var _props = this.props,
          ...
          onRef = _props.onRef,
          extra = _objectWithoutProperties(_props, ["children", "onScroll", "onRef"]);

      return _react2.default.createElement(
        "div",
        _extends({}, extra, { ref: this.handleRef, onScroll: this.throttleScroll }),
        children
      );
    }
  }]);
